...
public class MarkImgUtils {
	 ...
	 * 
	 * @param icon 水印图片路径
	 * @param source 没有加水印的图片路径
	 * @param output 加水印后的图片路径
	 * @param imageName 图片名称
	 * @param imageType 图片类型
	 * @param degree 水印图片旋转角度，为null表示不旋转
	 */
	public static boolean markImageByMoreIcon(String icon, String source,
	 ...
	 * @param degree 水印图片旋转角度，为null表示不旋转
	 */
	public static boolean markImageBySingleIcon(String icon, String source,
			String output, String imageName, String imageType, Integer degree) {
		boolean result = false;
		try {
			File file = new File(source);
	 ...
	 */
	public static boolean markImageByMoreText(String source, String output,
	 ...
	 * @param degree 水印文字旋转角度，为null表示不旋转
	 */
	public static boolean markImageBySingleText(String source, String output,
			String imageName, String imageType, Color color, String word,
			Integer degree) {
		boolean result = false;
		try {
	 ...
	 * 
	 * @param source 原图片路径
	 * @param output 打马赛克后，图片保存的路径
	 * @param imageName 图片名称
	 * @param imageType 图片类型
	 * @param size 马赛克尺寸，即每个矩形的宽高
	 * @return
	 */
	public static boolean markImageByMosaic(String source, String output,
